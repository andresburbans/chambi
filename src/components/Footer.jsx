        ...
        <footer className="footer">
            <div className="footer-content">
                <div className="social-icons">
                    <a href="https://github.com/andresburbans/chambi" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                    ...
                    <a href="https://github.com/andresburbans/chambi" target="_blank" rel="noopener noreferrer" aria-label="X">
